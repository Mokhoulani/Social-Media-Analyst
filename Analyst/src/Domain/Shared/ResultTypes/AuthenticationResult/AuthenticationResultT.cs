...
public sealed class AuthenticationResult<T> : Result<T>, IAuthenticationResult
{
    ...
    public static AuthenticationResult<T> Unauthenticated(string code, string message) =>
